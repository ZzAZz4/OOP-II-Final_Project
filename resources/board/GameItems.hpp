...
#ifndef UNTITLED1_GAMEITEMS_HPP
#define UNTITLED1_GAMEITEMS_HPP
#define DEBUG 1
...
public:
    ...
    Boat
        (Point_t spawn = {0, 0},
         Direction::type dir = Direction::Right,
         size_t size = 0)
        : Segment<T>(spawn, spawn + Point<T>(dir) * (size - 1)), _size(size), _lives(size)
    {}
